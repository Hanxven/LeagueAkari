...
- [UNFINISHED] League Akari 现在会执行自动更新。

- [UNFINISHED] 现在玩家搜索功能会添加历史记录。

- [UNFINISHED] 添加了一个选项，可以筛选当前战绩页面的模式。

- [UNFINISHED] 现在搜索过的玩家会短暂记录。
...
- 模拟键盘发送类功能现在可以中途取消，方法是再次按下快捷键。

- 移除了连接页面。在左下角的连接入口将可连接到当前已启动的客户端。
