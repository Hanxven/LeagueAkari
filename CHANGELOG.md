...
- 提供了一个外部数据源，将通过 SGP 接口进行战绩查询。

- [UNFINISHED] 现在可以提供用于 KDA 发送的自定义 JavaScript 脚本。

- [UNFINISHED] 自动选择和自动禁用现在可以设置不同的位置。
...
- [CONFIRMATION REQUIRED] 自动点赞导致黑屏，自动点赞无法收到。

- 有玩家战绩为空时，对局分析部分逻辑出现问题。

## 调整

- 自动选择和自动禁用板块 UI 调整，使其不混乱。
