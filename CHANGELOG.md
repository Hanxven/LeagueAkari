...
- [URGENT] 调整外部数据源模块的实现方式，使其支持更灵活的数据源配置。

- [UNFINISHED] 支持查看存储中的内容，支持导出。

- [UNFINISHED] 现在会分析战绩页中更多的数据，包括标记过的玩家以及历史对局结果等。

- [UNFINISHED] 提供了一个外部数据源，将通过 SGP 接口进行战绩查询。

- [UNFINISHED] Swarm 模式战绩展示调整。

## 修复

- [TEST REQUIRED] 自动点赞功能问题。

## 调整

- [UNFINISHED] 自动选择和自动禁用板块 UI 调整，使其不混乱。

- [UNFINISHED] 战绩伤害面板显示数字，而不是仅展示百分比。

- [UNFINISHED] 对局页面布局调整，使其更加美观。

- [UNFINISHED] 英雄选择小组件支持拖动，以及复杂编辑。

- [UNFINISHED] 小窗的快捷设置入口提供更多的设置项和反馈效果。

- [IDEA] 支持双语言，EN/CH。

- [UNFINISHED] 移除隐藏生涯嘲讽语句横幅。

- [UNFINISHED] 自动下载的新版本，可以在设置页中查看下载好的新版本内容。

- [UNFINISHED] 战绩页面将请求全部战绩。

- 战绩页面展开某一个对局将不再折叠其他对局。
