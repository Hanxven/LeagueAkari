...
import { Lobby, ReceivedInvitation } from '@shared/types/lcu/lobby'
...
export const useLeagueClientStore = defineStore('store:league-client-renderer', () => {
  ...
  const champSelect = {
    ...
    currentPickableChampionIds: shallowRef<number[]>([]),
    currentBannableChampionIds: shallowRef<number[]>([]),
    disabledChampionIds: shallowRef<number[]>([])
  } as const
