...
const statsConfigMap = {
  ...
  playerAugment1: { name: '增益1', render: augmentDisplay },
  playerAugment2: { name: '增益2', render: augmentDisplay },
  playerAugment3: { name: '增益3', render: augmentDisplay },
  playerAugment4: { name: '增益4', render: augmentDisplay },
